...
export default class FixListChoose extends React.Component{
    state={
            ...
            <View style={styles.container}>
                ...
                <FlatList    
                    ...
                    <Button
                        ...
                        onPress={() => this.props.navigation.navigate("FixList", {detail: item[1].info, userID: this.state.userID, idClass: this.state.lists[0][0].id})}
                    />}
